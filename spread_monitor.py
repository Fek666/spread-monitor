...
CONFIG = {
    "tickers": [t.strip() for t in os.getenv(
        ...
        "COST,CRCL,CRM,CRWD,CRWV,CSCO,CVX,DIS,DRAM,EWJ,EWT,EWY,FCX,FLNC,FOX,"
        ...
        "MINIMAX,MRVL,MSFT,MSTR,MU,NBIS,NEM,NKE,NOK,NVDA,NVO,OKLO,ONDS,ORCL,OXY,"
        ...
        "UNH,UPST,USAR,V,VRT,VST,WDC,WMT,XLE,XOM,ZHIPU,"
